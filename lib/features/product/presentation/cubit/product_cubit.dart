...
/////////////////////////////////////////////////////////////////////
  ...
  List<ProductModel> localProds = [
    ...
    ProductModel(
      productId: 'samsung-s22-ultra-256gb-black',
      productTitle:
    ...
    ProductModel(
      productId: 'samsung-s21-ultra-5g',
      productTitle:
    ...
    ProductModel(
      productId: 'oneplus-9-pro-5g-256gb',
      productTitle:
    ...
    ProductModel(
      productId: 'samsung-galaxy-z-flip3-5g',
    ...
    ProductModel(
      productId: 'iphone14-plus-6-7inch',
    ...
    ProductModel(
      productId: 'xiaomi-redmi-note10-pro',
    ...
    // Watches
    ProductModel(
      productId: 'apple-watch-series-7',
    ...
    ProductModel(
      productId: 'samsung-galaxy-watch-4',
    ...
    ProductModel(
      productId: 'fitbit-sense-advanced',
    ...
    ProductModel(
      productId: 'garmin-forerunner-945-lte',
    ...
    // Shoes
    ProductModel(
      productId: 'nike-air-force-1-07-v1',
    ...
    ProductModel(
      productId: 'adidas-ultraboost-21-v1',
    ...
    ProductModel(
      productId: 'converse-chuck-taylor-high-top',
    ...
    ProductModel(
      productId: 'new-balance-fresh-foam-1080v11-v1',
    ...
    ProductModel(
      productId: 'adidas-ultraboost-21-v2',
      productTitle: "Adidas Ultraboost 21",
      productPrice: "180.7",
      productCategory: "Shoes",
      productDescription:
    ...
    ProductModel(
      productId: 'new-balance-fresh-foam-1080v11-v2',
      productTitle: "New Balance Fresh Foam 1080v11",
      productPrice: "149.99",
      productCategory: "Shoes",
      productDescription:
    ...
    ProductModel(
      productId: 'puma-future-z-1-1-fg-ag',
    ...
    // Accessories
    ProductModel(
      productId: 'ray-ban-wayfarer-sunglasses',
    ...
    ProductModel(
      productId: 'herschel-settlement-backpack',
    ...
    ProductModel(
      productId: 'fjallraven-kanken-classic-backpack',
    ...
    ProductModel(
      productId: 'nike-air-force-1-07-v2',
      productTitle: "Nike Air Force 1 '07",
      productPrice: "90.99",
      productCategory: "Shoes",
      productDescription:
    ...
    ProductModel(
      productId: 'adidas-ultraboost-21-v3',
      productTitle: "Adidas Ultraboost 21",
      productPrice: "180.99",
      productCategory: "Shoes",
      productDescription:
    ...
    ProductModel(
      productId: 'converse-chuck-taylor-low-top',
    ...
    ProductModel(
      productId: 'vans-old-skool-classic-skate',
